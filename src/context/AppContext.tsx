  ...
  const loadProfile = async (userId: string) => {
    ...
    if (data) {
      ...
      setUser({
        ...
        canDaily:               data.can_daily ?? false,
        canRobe:                data.can_robe ?? false,
