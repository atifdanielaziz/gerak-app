  ...
  return (
    <div className="flex-grow bg-white overflow-y-auto no-scrollbar pb-8 px-5 animate-fade-in flex flex-col gap-4">
      ...
      <Section title="2. What we collect">
        <p><strong>Account &amp; identity:</strong> full name, matric number, IC/MyKad number, phone number, email address, university, faculty and campus.</p>
        <p><strong>Verification documents:</strong> for drivers and Jubah riders — IC copy and driving licence images, uploaded for admin review.</p>
      ...
      <Section title="5. IC/MyKad number handling">
        <p>
          Your IC number is collected only where required — identity verification for drivers/riders, and as an
          ownership check for Jubah booking lookups. It is masked (only the first 6 digits, i.e. your date of birth,
          are ever shown) everywhere it's displayed after initial submission, including in receipts, emails, and
          admin views. Full IC numbers are never included in email receipts.
        </p>
      </Section>
