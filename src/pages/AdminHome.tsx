...
export const AdminHome: React.FC = () => {
  ...
  useEffect(() => {
    const anyOpen = !!sheetUser || jubahRiderModalOpen || usersModalOpen || receiptsModalOpen || driversModalOpen || !!receiptModal;
    if (!anyOpen) return;
    setSheetOpen(true);
    return () => setSheetOpen(false);
  }, [sheetUser, jubahRiderModalOpen, usersModalOpen, receiptsModalOpen, driversModalOpen, receiptModal, setSheetOpen]);
