                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="bg-white border border-slate-100 rounded-3xl p-5 flex flex-col gap-4">
                    ...
                    {/* Initial payment proof — shown whenever one was submitted,
                        independent of the Confirm Payment action's own availability
                        below, so it stays visible (for reference/audit) even after
                        the job has moved on or fully completed — not just while
                    ...
                    {selectedJob.payment_path && (
                      <div className="rounded-xl p-3 border bg-white border-slate-100 flex items-center justify-between gap-2">
                        <div>
                          <span className="text-[8px] font-semibold block text-slate-400">
                            {selectedJob.payment_mode === 'deposit' ? 'Deposit Payment' : 'Initial Payment'}
                          </span>
