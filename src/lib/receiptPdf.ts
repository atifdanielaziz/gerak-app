...
.title{text-align:center;font-size:13px;font-weight:700;margin-bottom:18px}
.brand{display:flex;align-items:center;gap:10px;margin-bottom:14px}
.tagline{font-size:10px;color:#94a3b8}
.details{background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;padding:14px 16px}
...
<div class="title">${escapeHtml(doc.subtitle)}</div>
