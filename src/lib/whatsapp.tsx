...
/* Normalise any Malaysian number to WhatsApp-compatible format (6012xxxxxxx) */
export const toWa = (phone: string): string => {
...
export const WaIcon: React.FC<{ className?: string }> = ({ className }) => (
