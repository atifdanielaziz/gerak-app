-- Keep pgcrypto available inside SECURITY DEFINER quote functions. Supabase
-- commonly installs pgcrypto in the extensions schema, while the earlier
-- functions restricted search_path to public only.
