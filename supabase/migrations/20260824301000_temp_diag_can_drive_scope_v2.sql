-- Temporary read-only diagnostic v2 (adds invite/created_at correlation) —
-- dropped in a follow-up migration once root-cause is confirmed.
drop function if exists public.diag_can_drive_scope();
